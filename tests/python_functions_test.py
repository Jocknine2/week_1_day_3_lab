...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
      volume_of_cube = number_of_cube_length(3)
  ...
  def test_reverse_string(self):
      string_of_text = reverse_string("qwerty")
      self.assertEqual("ytrewq", string_of_text)

    
  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius(self):
      temperature_in_celsius = fahrenheit_to_celsius(50)
      self.assertEqual(10, temperature_in_celsius)
